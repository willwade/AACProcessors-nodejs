/**
 * Grid3 Wordlist Demo (JavaScript)
 * 
 ...
 * 
 * Run with: node examples/wordlist-demo.js
 */

const fs = require('fs');
const path = require('path');
const { createWordlist, extractWordlists, updateWordlist } = require('../dist/index');

async function main() {
  console.log('=== Grid3 Wordlist Demo (JavaScript) ===\n');
