...
async function main() {
  ...
  keyboard.addButton(
    new AACButton({
      ...
      semanticAction: {
        ...
        platformData: {
          grid3: { commandId: 'ComputerControl.Shift', parameters: { action: 'Toggle' } },
        },
      },
    })
  );
  ...
  keyboard.addButton(
    new AACButton({
      ...
      semanticAction: {
        ...
        text: '{TAB}',
        platformData: {
          grid3: { commandId: 'ComputerControl.Keyboard', parameters: { keystring: '{TAB}' } },
        },
      },
    })
  );
  ...
  keyboard.addButton(
    new AACButton({
      ...
      semanticAction: {
        ...
        text: '{ESC}',
        platformData: {
          grid3: { commandId: 'ComputerControl.Keyboard', parameters: { keystring: '{ESC}' } },
        },
      },
    })
  );
  ...
  keyboard.addButton(
    new AACButton({
      ...
      semanticAction: {
        ...
        text: '{UP}',
        platformData: {
          grid3: { commandId: 'ComputerControl.Keyboard', parameters: { keystring: '{UP}' } },
        },
      },
    })
  );
  ...
  keyboard.addButton(
    new AACButton({
      ...
      semanticAction: {
        ...
        text: '{LEFT}',
        platformData: {
          grid3: { commandId: 'ComputerControl.Keyboard', parameters: { keystring: '{LEFT}' } },
        },
      },
    })
  );
  ...
  keyboard.addButton(
    new AACButton({
      ...
      semanticAction: {
        ...
        text: '{DOWN}',
        platformData: {
          grid3: { commandId: 'ComputerControl.Keyboard', parameters: { keystring: '{DOWN}' } },
        },
      },
    })
  );
  ...
  keyboard.addButton(
    new AACButton({
      ...
      semanticAction: {
        ...
        text: '{RIGHT}',
        platformData: {
          grid3: { commandId: 'ComputerControl.Keyboard', parameters: { keystring: '{RIGHT}' } },
        },
      },
    })
  );
  ...
  keyboard.addButton(
    new AACButton({
      ...
      semanticAction: {
        ...
        platformData: {
          grid3: {
            commandId: 'ComputerControl.Keyboard',
            parameters: { keystring: '{LEFTCONTROL}c' },
          },
        },
      },
    })
    ...
    new AACButton({
      ...
      semanticAction: {
        ...
        platformData: {
          grid3: {
            commandId: 'ComputerControl.Keyboard',
            parameters: { keystring: '{LEFTCONTROL}v' },
          },
        },
      },
    })
    ...
    new AACButton({
      ...
      semanticAction: {
        ...
        platformData: {
          grid3: {
            commandId: 'ComputerControl.Keyboard',
            parameters: { keystring: '{LEFTCONTROL}z' },
          },
        },
      },
    })
    ...
    new AACButton({
      ...
      semanticAction: {
        ...
        platformData: {
          grid3: {
            commandId: 'ComputerControl.Keyboard',
            parameters: { keystring: '{LEFTCONTROL}a' },
          },
        },
      },
    })
    ...
    mouse.addButton(
      new AACButton({
        ...
        semanticAction: {
          ...
          text: m.key,
          platformData: {
            grid3: { commandId: 'ComputerControl.Keyboard', parameters: { keystring: m.key } },
          },
        },
      })
    );
  ...
  mouse.addButton(
    new AACButton({
      ...
      semanticAction: {
        ...
        platformData: {
          grid3: {
            commandId: 'CommandExecution.Wait',
            parameters: { waittime: '00:00:00.5000000' },
          },
        },
      },
    })
    ...
    shortcuts.addButton(
      new AACButton({
        ...
        semanticAction: {
          ...
          text: sc.key,
          platformData: {
            grid3: { commandId: 'ComputerControl.Keyboard', parameters: { keystring: sc.key } },
          },
        },
      })
    );
  ...
  system.addButton(
    new AACButton({
      ...
      semanticAction: {
        ...
        platformData: {
          grid3: { commandId: 'ComputerControl.DeviceMute', parameters: { indicatorenabled: '1' } },
        },
      },
    })
  );
  ...
  photos.addButton(
    new AACButton({
      ...
      semanticAction: {
        ...
        platformData: {
          grid3: { commandId: 'Photos.ChangeCamera', parameters: { indicatorenabled: '1' } },
        },
      },
    })
  );
  ...
  for (const [id, page] of Object.entries(reloaded.pages)) {
    const wsBtns = page.buttons.filter(
      (b) => b.contentType === 'Workspace' || b.contentType === 'AutoContent'
    );
    console.log(
    ...
    for (const btn of wsBtns) {
      console.log(
        `    CELL: ${btn.contentType}/${btn.contentSubType} @ (${btn.x},${btn.y}) span=(${btn.columnSpan}x${btn.rowSpan})`
      );
    }
  }
}
