...
describe('GridsetProcessor round-trip', () => {
  ...
  it('round-trips Gridset JSON without losing pages or navigation', () => {
    ...
    const tree1 = GridsetProcessor.prototype.loadIntoTree.call(GridsetProcessor, gsPath);
    GridsetProcessor.prototype.saveFromTree.call(GridsetProcessor, tree1, outPath);
    const tree2 = GridsetProcessor.prototype.loadIntoTree.call(GridsetProcessor, outPath);
