...
describe('TouchChatProcessor.saveFromTree', () => {
  ...
  it('exports tree to TouchChat JSON', () => {
    ...
    const tree = require('../src/processors/touchchatProcessor').prototype.loadIntoTree.call(TouchChatProcessor, tcPath);
    TouchChatProcessor.prototype.saveFromTree.call(TouchChatProcessor, tree, outPath);
