...
describe('Performance Tests', () => {
  ...
  describe('Large File Processing', () => {
    ...
    it('should handle large trees in saveFromTree operations', () => {
      ...
      console.log(`DOT Save Performance: ${processingTime.toFixed(2)}ms, Memory: +${memoryIncrease}MB`);
    ...
    it('should handle large translation operations efficiently', () => {
      ...
      console.log(`DOT Translation Performance: ${processingTime.toFixed(2)}ms, Memory: +${memoryIncrease}MB`);
  ...
  describe('Memory Usage Patterns', () => {
    ...
    it('should handle concurrent processing efficiently', async () => {
      ...
      console.log(`Concurrent Performance: ${processingTime.toFixed(2)}ms, Memory: +${memoryIncrease}MB`);
  ...
  describe('Database Performance', () => {
    it('should handle large Snap databases efficiently', () => {
      ...
      console.log(`Snap DB Performance: Save ${saveProcessingTime.toFixed(2)}ms, Load ${loadProcessingTime.toFixed(2)}ms, Memory: +${memoryIncrease}MB`);
